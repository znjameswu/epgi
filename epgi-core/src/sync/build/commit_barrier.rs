...
pub(in crate::sync) struct CommitBarrierInner {
    counter: AtomicIsize,
...
impl CommitBarrierInner {
    ...
    pub(in crate::sync) fn inc(&self) {
        self.counter.fetch_add(1, Relaxed);
    }

    pub(in crate::sync) fn new() -> Self {
        Self {
    ...
    pub(in crate::sync) fn is_empty(&self) -> bool {
...
impl CommitBarrier {
    ...
    pub(in crate::sync) fn from_inner(inner: Asc<CommitBarrierInner>) -> Self {
