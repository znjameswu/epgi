...
// pub(crate) enum ElementSnapshotInner<E: ElementNew> {
...
// impl<E: ElementNew> ElementSnapshotInner<E> {
...
// // pub(crate) enum MainlineState<E: Element, RO> {
// //     Ready {
// //         element: E,
// //         hooks: Hooks,
// //         children: ContainerOf<E, ArcChildElementNode<E::ChildProtocol>>,
// //         render_object: Option<RO>,
// //     },
// //     InflateSuspended {
